...
embeddings_2d = PCA(n_components= 2).fit_transform(z)    
##################
# your code here #
##################
...
############## Task 5
clusters = KMeans(n_clusters= 2).fit(z)
print("clusters :", clusters.labels_)
print("homogeneity score: ", homogeneity_score(y , clusters.labels_))    
##################
# your code here #
##################